...
import { sha256Hex, canonicalize, computeRecordHash, readFileWithHash } from "../../application/crypto";
    ...
    <div>
      ...
      <Card>
        <div className="flex gap-2 mb-4">
          <Btn small kind={mode === "qr" ? "primary" : "ghost"} onClick={() => { setMode("qr"); setResult(null); }}>Scan QR (paste token)</Btn>
