...
import { Badge, Card, Btn, SectionTitle, inputCls, inputStyle } from "./ui";
            ...
            <Card key={i.id}>
              <div className="flex items-center justify-between gap-3 flex-wrap">
                <div>
                  ...
                  <div className="text-xs" style={{ color: C.gray }}>{i.kind || "Institution"} · Accreditation no. {i.accreditationNo} · {i.country}</div>
                </div>
